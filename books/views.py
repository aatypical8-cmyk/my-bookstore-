...
from django.contrib.auth.decorators import login_required
from django.contrib import messages
from .models import PaymentConfirmation  # Make sure it uses the correct model


@login_required
def delete_pending_purchase(request, pk):
    # Fetch from PaymentConfirmation instead of Purchase
    payment = get_object_or_404(PaymentConfirmation, pk=pk)
